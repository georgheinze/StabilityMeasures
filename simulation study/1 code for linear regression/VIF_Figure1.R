...
bwAIC_sub50 <-
  sub_bwAIC_mat50[seq(1, nrow(sub_bwAIC_mat50) - 1, 2),][, -1]
bwAIC_sub63 <-
  sub_bwAIC_mat63[seq(1, nrow(sub_bwAIC_mat63) - 1, 2),][-c(4:6), -1]
bwAIC_sub80 <-
  sub_bwAIC_mat80[seq(1, nrow(sub_bwAIC_mat80) - 1, 2),][, -1]
bwAIC_boot <-
  boot_bwAIC_mat[seq(1, nrow(boot_bwAIC_mat) - 1, 2),][-c(4:6), -1]
